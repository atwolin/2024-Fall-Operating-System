...
class FileSystem {
   public:
    ...
    void List(char *name, bool isRecursive);  // List all the files in the file system

    void Print();  // List all the files and their contents


    char* FilenameCapture(char* name);
    char* CreateTraverse(Directory* dir, char* name);
